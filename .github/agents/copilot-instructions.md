...
- TypeScript 5.x with Next.js 16.1.6 (App Router), React 19.2.3 + @clerk/nextjs (auth), @prisma/client (ORM), @heroicons/react (icons), Tailwind CSS 4.x (styling) (003-mobile-responsive-animations)
...
- TypeScript 5.x with Next.js 16 (App Router) + Next.js, React 18+, Prisma (ORM), Clerk (auth), Tailwind CSS, Vercel Blob (006-faq-magazine-sections)
- PostgreSQL on Neon (serverless), Vercel Blob for media files (fallback: local DB) (006-faq-magazine-sections)
...
## Recent Changes
- 006-faq-magazine-sections: Added TypeScript 5.x with Next.js 16 (App Router) + Next.js, React 18+, Prisma (ORM), Clerk (auth), Tailwind CSS, Vercel Blob
