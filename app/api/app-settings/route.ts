    ...
    if (!settings) {
      settings = await prisma.app_settings.create({
        data: {
          ...
          site_favicon_storage_type: 'upload',
    ...
    if (!settings) {
      ...
      settings = await prisma.app_settings.create({
        data: {
          ...
          site_favicon_url,
          site_favicon_storage_type: site_favicon_storage_type || 'upload',
          og_image_url,
      ...
      settings = await prisma.app_settings.update({
        ...
        data: {
          ...
          ...(custom_color_1 !== undefined && { custom_color_1 }),
          ...(custom_color_2 !== undefined && { custom_color_2 }),
          ...(custom_color_3 !== undefined && { custom_color_3 }),
          ...(custom_color_4 !== undefined && { custom_color_4 }),
          ...(custom_color_5 !== undefined && { custom_color_5 }),
          ...
          ...(site_favicon_url !== undefined && { site_favicon_url }),
          ...(site_favicon_storage_type !== undefined && { site_favicon_storage_type }),
