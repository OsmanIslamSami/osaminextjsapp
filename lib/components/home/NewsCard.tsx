  ...
  return (
    ...
    >
      ...
      <div className="relative h-full w-full bg-gradient-to-br from-blue-500 to-purple-500">
        ...
        {/* Hover indicator */}
        <div
          className="absolute top-4 right-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-full text-xs font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-300 motion-reduce:opacity-0 shadow-lg"
          aria-hidden="true"
        >
